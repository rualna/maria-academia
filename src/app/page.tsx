...
const [mission, setMission] = useState<any>(null)
  ...
  useEffect(() => {
    async function initUser() {
      ...
      // Alta del perfil del estudiante. Si falla, lo dejamos visible en consola
      ...
      if (!res.ok) {
        ...
        console.error(`[create-student] No se pudo crear el perfil (HTTP ${res.status}).`, detail)
      }
  ...
  return (
    // 34 — Mobile: min-h-screen, padding ajustado en móvil
    <main className="min-h-screen bg-slate-950 text-white flex items-start sm:items-center justify-center p-3 sm:p-6">
      <div className="w-full max-w-4xl bg-slate-900 rounded-2xl p-4 sm:p-6 shadow-xl border border-slate-700">
        ...
        {/* Header — 34 mobile: texto más pequeño en móvil */}
        ...
        {/* Chat — 34 mobile: altura adaptable */}
        <div className="h-72 sm:h-96 overflow-y-auto bg-slate-950 border border-slate-800 rounded-xl p-3 sm:p-4 mb-3 space-y-3">
          ...
          {/* 20 — Realtime UI: typing indicator animado */}
          {loading && (
          ...
          {/* 19 — anchor scroll automático */}
          <div ref={chatEndRef} />
        </div>

        {/* Input — 34 mobile: input y botón apilados en móvil pequeño */}
